...
## Release 0.1.12 (2020-06-11T21:43:13)
* add limit
* Add check on retrieval
* import np
* Adjust interval
* Adjust inputs and datetime
* Adjust interval to be weekly
* Adjust methods for plots and aggregation
* added a 'tekton trigger tag_release pipeline issue'
* Release of version 0.1.11
* Correct docstring
* Adjust type
* Add solver specific functions
* Add github templates
